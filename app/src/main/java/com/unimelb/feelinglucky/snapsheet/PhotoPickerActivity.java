...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    private void initView() {
        mGridView = (GridView) findViewById(com.lling.photopicker.R.id.photo_gridview);
        mPhotoNumTV = (TextView) findViewById(com.lling.photopicker.R.id.photo_num);
        mPhotoNameTV = (TextView) findViewById(com.lling.photopicker.R.id.floder_name);
        ((RelativeLayout) findViewById(com.lling.photopicker.R.id.bottom_tab_bar)).setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        ((ImageView) findViewById(com.lling.photopicker.R.id.btn_back)).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initIntentParams() {
        ...
        if(mSelectMode == MODE_MULTI) {
            ...
            mCommitBtn = (Button) findViewById(com.lling.photopicker.R.id.commit);
...
//        mProgressDialog.dismiss();
        ...
        mPhotoNumTV.setText(OtherUtils.formatResourceString(getApplicationContext(),
                com.lling.photopicker.R.string.photos_num, mPhotoLists.size()));
    ...
    private void toggleFloderList(final List<PhotoFloder> floders) {
        ...
        if(!mIsFloderViewInit) {
            ViewStub floderStub = (ViewStub) findViewById(com.lling.photopicker.R.id.floder_stub);
            floderStub.inflate();
            View dimLayout = findViewById(com.lling.photopicker.R.id.dim_layout);
            mFloderListView = (ListView) findViewById(com.lling.photopicker.R.id.listview_floder);
